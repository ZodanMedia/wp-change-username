...
class Simple_Settings {
	...
	public function render_settings_page() {
		...
		<div class="wrap simple-settings-page">
			...
			?>
			<div id="tab_container" class="simple-settings-options-table zodan-change-username-options">
				<form method="post" action="options.php">
					...
					if ( ! in_array( $active_tab, apply_filters( $this->func . '_unsavable_tabs', array() ), true ) ) {
						...
						submit_button(null,null,'submit-settings');
					}
					?>
				</form>
			</div>
